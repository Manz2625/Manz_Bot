...
* HARGAILAH YT MEMBUAT SCRIPT INI BOSQ
* JANGAN UBAH-UBAH INFO!!!
* ARIS187 ID
* BOLEH UBAH TAPI KECUALI INFO!!!
*/
const A187 = '👾Manz_-BOT👾'; // JANGAN UBAH-UBAH INFO!!!
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾Manz_-BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/_sadboy.ig_' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾Manz_-BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/_sadboy.ig_' ,MessageType.text);
}
